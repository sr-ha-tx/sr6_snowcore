...
select count(1) from sales_db.source.in_sales_order;
select count(1) from sales_db.source.us_sales_order;
select count(1) from sales_db.source.fr_sales_order;
select * from sales_db.curated.in_sales_order limit 10;
